...
export default class BaseDao {
  ...
  findById(_id: any, projection?: any | null, options?: QueryOptions | null) {
    return this.model.findById(_id, projection, options).exec()
  }

  findByIdAndUpdate(_id: any, update: any, options?: any) {
    return this.model.findByIdAndUpdate(_id, update, options).exec()
  }
  ...
  findByIdAndDelete(id: any, options?: QueryOptions | null): Promise<any> {
